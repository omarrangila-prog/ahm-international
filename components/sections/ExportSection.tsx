        ...
        <div className="grid grid-cols-12 gap-y-10 lg:gap-x-12">
          ...
          <div className="col-span-12 lg:col-span-5">
            ...
            <div className="mt-7 border-l-2 border-lime pl-5">
              <p className="text-lead text-cream/85">{EXPORT_STATEMENT}</p>
            </div>

            <dl className="mt-10 flex flex-col gap-5">
              {fobScope.map((item) => (
                <div key={item.title} className="border-t border-cream/15 pt-4">
                  <dt className="font-display text-[0.9375rem] font-bold tracking-[-0.015em] text-cream">
                    {item.title}
                  </dt>
                  <dd className="mt-1 text-sm leading-relaxed text-cream/60">{item.body}</dd>
                </div>
              ))}
            </dl>
          ...
          <div className="col-span-12 lg:col-span-7">
            <Reveal>
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-5">
                <div className="relative aspect-[4/3] overflow-hidden border border-cream/12 bg-graphite/60 sm:col-span-3 sm:aspect-auto sm:min-h-[19rem]">
                  <SmartImage
                ...
                <div className="grid grid-cols-2 gap-3 sm:col-span-2 sm:grid-cols-1">
                  <div className="relative aspect-[4/3] overflow-hidden border border-cream/12 bg-graphite/60">
                    <SmartImage
            ...
            <dl className="mt-4 grid grid-cols-1 gap-px border border-cream/12 bg-cream/12 sm:grid-cols-2">
              <div className="bg-graphite/60 px-5 py-4">
                <dt className="label text-lime">Documented lane</dt>
                <dd className="mt-1.5 text-sm text-cream/75">
                  {ORIGIN.port} &rarr; United States
                </dd>
              </div>
              <div className="bg-graphite/60 px-5 py-4">
                <dt className="label text-cream/55">Target buyer markets</dt>
                <dd className="mt-1.5 text-sm text-cream/75">
            ...
            <p className="mt-5 text-xs leading-relaxed text-cream/60">{MARKET_STATEMENT}</p>
          </div>
        </div>
      </div>
    </Section>
