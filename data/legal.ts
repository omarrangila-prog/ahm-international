...
export const LEGAL_EFFECTIVE = "August 2026" as const;
...
export const privacySections: LegalSection[] = [
  ...
  },
  {
    ...
    list: [
      ...
      "Files you attach: tech packs, sketches, bills of materials, size specifications and reference images. Accepted formats are PDF, XLSX, DOCX, JPG, PNG, WEBP and ZIP, up to 15 MB per file and 40 MB per submission.",
  ...
  },
  {
    ...
    body: [
      ...
      "The infrastructure providers that host this website and deliver our email. They process data on our instruction and do not use it for their own purposes.",
  ...
  },
  {
    ...
    body: [
      "Enquiries and attachments are kept for as long as the commercial conversation is live, and afterwards for as long as we may reasonably need them, for example to honour a repeat order against a specification you approved earlier.",
      "Ask us to delete your enquiry and its files and we will, unless we are required to retain a record for tax or legal reasons.",
    ],
  },
  {
    heading: "Your rights",
...
export const termsSections: LegalSection[] = [
  ...
  },
  {
    ...
    body: [
      "Photographs show articles manufactured to buyer specification. They are construction references. They are not an offer of a specific garment, and the presence of a garment on this site does not imply that any brand shown is a current customer or endorses AHM International.",
  ...
  },
  {
    ...
    body: [
      ...
      "Third-party brand marks appearing on photographed garments belong to their owners.",
    ],
  },
  {
